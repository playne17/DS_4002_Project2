...
```{r}
summary(remote_pred)
#469 "0s" or non fradualent and 131 "1s" or fruadulent. 21.83% of jobs expected to be fraudlent
summary(regular_pred)
#190 "0s" or non fraudelnt and 410 "1s" or fruadulent. 68.33% of jobs expected to be fraudlent!
```
